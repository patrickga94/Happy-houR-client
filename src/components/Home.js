			...
			<div className="home-page">
				<h1 className="mb-5">Welcome to Happy houR!</h1>
					<div className="app-description">
						...
						<Link to='guest/sign-up' className="btn btn-info m-1" >Guest Sign Up</Link>
						<Link to='guest/sign-in'  className="btn btn-info m-1">Guest Sign In</Link>
						<Link to='establishment/sign-up' className="btn btn-info m-1">Establishment Sign Up</Link>
						<Link to='establishment/sign-in'  className="btn btn-info m-1">Establishment Sign In</Link>
					</div>
			</div>
		</>
